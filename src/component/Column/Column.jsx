    ...
    return (
        <div className="column">
            ...
            <div className="column__title">
                <h2 className="column__title-sup">Сгенерированные пароли</h2>
                <svg
                    onClick={handleIconClick}
                    className={isRotated ? 'rotateIcon1' : 'rotateIcon2'}
                    width="20px" 
                    height="20px" 
                    viewBox="0 0 16 16" 
            ...
            <div className="column__paswords">
                {
